...
Sinch = {
    ...
    verifySignature: function (options) {
        var verifyReq = {
	    ...
	    sinchRequest.applicationSigned(verifyReq, {key: this.options.appKey, secret: this.options.appSecret});
	    
	    if (options.headers.authorization === verifyReq.headers.authorization) return true;
	    else return false;
    },
